...
void createDefaultIcons(Map flutterLauncherIconsConfig, String flavor) {
  ...
  if (isCustomAndroidFile(flutterLauncherIconsConfig)) {
    ...
    androidIcons.forEach((AndroidIconTemplate e) =>
        overwriteExistingIcons(e, image, constants.androidFileName, flavor));
...
void createAdaptiveIcons(Map flutterLauncherIconsConfig, String flavor) {
...
void createAdaptiveIconMipmapXmlFile(Map flutterLauncherIconsConfig, String flavor) {
  if (isCustomAndroidFile(flutterLauncherIconsConfig)) {
...
void createAdaptiveBackgrounds(
    Map yamlConfig, String adaptiveIconBackgroundImagePath, String flavor) {
  ...
  adaptiveForegroundIcons.forEach((AndroidIconTemplate androidIcon) =>
      saveNewImages(
          androidIcon, image, constants.androidAdaptiveBackgroundFileName, flavor));
...
void overwriteExistingIcons(AndroidIconTemplate template, Image image, String filename, String flavor) {
  Image newFile;
...
Future<void> overwriteAndroidManifestWithNewLauncherIcon(String iconName, [String flavor]) async {
