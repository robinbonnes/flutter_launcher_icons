const String androidResFolder(String flavor) => "android/app/src/${flavor ?? 'main'}/res/";
const String androidColorsFile(String flavor) => "android/app/src/${flavor ?? 'main'}/res/values/colors.xml";
const String androidManifestFile(String flavor) => "android/app/src/${flavor ?? 'main'}/AndroidManifest.xml";
...
const String androidAdaptiveXmlFolder(String flavor) => androidResFolder(flavor) + "mipmap-anydpi-v26/";
